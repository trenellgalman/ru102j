...
public class CompareAndUpdateScript {
  ...
  public void updateIfGreater(Transaction jedis, String key, String field, Double value) {
    update(jedis, key, field, value, ScriptOperation.GREATERTHAN);
  }

  public void updateIfLess(Transaction jedis, String key, String field, Double value) {
    update(jedis, key, field, value, ScriptOperation.LESSTHAN);
  }

  private void update(
      Transaction jedis, String key, String field, Double value, ScriptOperation op) {
    if (sha != null) {
