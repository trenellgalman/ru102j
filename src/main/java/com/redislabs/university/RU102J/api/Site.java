...
public class Site implements Comparable<Site> {
  ...
  public Site(Map<String, String> fields) {
    if (!fields.containsKey("id")
        || !fields.containsKey("capacity")
        || !fields.containsKey("panels")) {
      throw new IllegalArgumentException(
          "Map<String, String> used to build a Site must "
    ...
    if (lat != null && lng != null) {
      this.coordinate =
          new Coordinate(fields.getOrDefault("lng", null), fields.getOrDefault("lat", null));
    }
  }
