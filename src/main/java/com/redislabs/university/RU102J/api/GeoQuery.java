...
public class GeoQuery {
  ...
  public GeoQuery(
      Coordinate coordinate, Double radius, String radiusUnit, boolean onlyExcessCapacity) {
    this.coordinate = coordinate;
    this.radius = radius;
    this.radiusUnit = GeoUnit.valueOf(radiusUnit);
  ...
  public GeoQuery(
      Coordinate coordinate, Double radius, GeoUnit radiusUnit, boolean onlyExcessCapacity) {
    this.coordinate = coordinate;
    this.radius = radius;
    this.radiusUnit = radiusUnit;
    this.onlyExcessCapacity = onlyExcessCapacity;
