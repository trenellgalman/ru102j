...
/**
 * Model class used to represent a single measurement at a particular time. These objects are
 * returned in API calls that may request a series of points for a chart.
 */
