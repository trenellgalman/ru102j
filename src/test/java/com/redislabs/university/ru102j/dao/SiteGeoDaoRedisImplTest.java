...
public class SiteGeoDaoRedisImplTest {
  ...
  public void generateData() {
    ...
    Site site1 = new Site(1, 4.5, 3, "637 Britannia Drive", "Vallejo", "CA", "94591");
    site1.setCoordinate(new Coordinate("-122.193849", "38.10476999999999"));
    sites.add(site1);

    Site site2 = new Site(2, 4.5, 3, "31353 Santa Elena Way", "Union City", "CA", "94587");
    site2.setCoordinate(new Coordinate("-122.059762", "37.593981"));
    sites.add(site2);

    Site site3 = new Site(3, 4.5, 3, "1732 27th Avenue", "Oakland", "CA", "94601");
  ...
  public void findByGeoWithExcessCapacity() {
    ...
    Site vallejo = new Site(1, 4.5, 3, "637 Britannia Drive", "Vallejo", "CA", "94591");
  ...
  public void insert() {
    SiteGeoDao dao = new SiteGeoDaoRedisImpl(jedisPool);
    Site vallejo = new Site(7, 4.5, 3, "637 Britannia Drive", "Vallejo", "CA", "94591");
