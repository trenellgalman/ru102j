...
public class SiteDaoRedisImplTest {
  ...
  public void generateData() {
    sites = new HashSet<>();
    sites.add(new Site(1, 4.5, 3, "123 Willow St.", "Oakland", "CA", "94577"));
    sites.add(new Site(2, 3.0, 2, "456 Maple St.", "Oakland", "CA", "94577"));
    sites.add(new Site(3, 4.0, 3, "789 Oak St.", "Oakland", "CA", "94577"));
  }

  /**
   * Challenge #0 Part 1. This challenge is explained in the video "How to Solve a Sample Challenge"
   */
  @Test
  public void findByIdWithExistingSite() {
    SiteDaoRedisImpl dao = new SiteDaoRedisImpl(jedisPool);
    Site site = new Site(4L, 5.5, 4, "910 Pine St.", "Oakland", "CA", "94577");
    dao.insert(site);
  ...
  /**
   * Challenge #0 Part 2. This challenge is explained in the video "How to Solve a Sample Challenge"
   */
  @Test
  ...
  /** Challenge #1 Part 1. Use this test case to implement the challenge in Chapter 1. */
  @Test
  ...
  /** Challenge #1 Part 2. Use this test case to implement the challenge in Chapter 1. */
  @Test
  ...
  public void insert() {
    SiteDaoRedisImpl dao = new SiteDaoRedisImpl(jedisPool);
    Site site = new Site(4, 5.5, 4, "910 Pine St.", "Oakland", "CA", "94577");
    dao.insert(site);
    ...
    assertThat(
        jedis.sismember(RedisSchema.getSiteIDsKey(), RedisSchema.getSiteHashKey(4L)), is(true));
  }
}
